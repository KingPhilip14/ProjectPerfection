...
{   
     ...
     */
    public static void startingCutscene(boolean isTesting)
    {
        if(!isTesting)
        {
     ...
     */
    public static void opiconCutscene(boolean isTesting)
    {
        if(!isTesting)
        {
            MainGame.clearScreen();
     ...
     */
    public static void opiconCutscene2(boolean isTesting)
    {
        if(!isTesting)
        {
            MainGame.clearScreen();
     ...
     */
    public static void waterVillageCutscene(boolean isTesting)
    {
        if(!isTesting)
        {
            MainGame.clearScreen();
     ...
     */
    public static void earthVillageCutscene(boolean isTesting)
    {
        if(!isTesting)
        {
